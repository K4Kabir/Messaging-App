        ...
        <>
            <Box height={'4em'}>
                <AppBar sx={{ bgcolor: orange }}>
                    <Toolbar>
                        <Typography variant='h5' sx={{ display: { xs: 'none', sm: 'block' } }}>Chat App</Typography>
                        ...
                        <Box sx={{ marginLeft: 'auto' }}>
                            <Box>
                                <NavigateIcon title={'Search'} Icon={SearchIcon} handler={handleOpenSearch} />
                                <NavigateIcon title={'Add'} Icon={AddIcon} handler={handleNewGroup} />
                                <NavigateIcon title={'Manage Group'} Icon={GroupIcon} handler={() => navigate('/group')} />
                                <NavigateIcon title={'Notification'} Icon={NotificationsIcon} handler={handleNotification} />
                                <NavigateIcon title={'Logout'} Icon={LogoutIcon} handler={() => navigate('/group')} />
                            </Box>
                        </Box>
                    </Toolbar>
                </AppBar>
